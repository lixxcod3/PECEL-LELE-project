            ...
            <div className="mb-8">
                ...
                <div className="grid gap-4 max-h-64 overflow-y-auto">
                    {questions.map((question, index) => {
                        const answer = answers.find((a) => a.questionNo === question.no);
                        const isCorrect = answer?.isCorrect ?? false;

                        return (
                            <div key={index} className={`flex items-center justify-between p-4
                            rounded-lg border-2 ${isCorrect 
                ...
                <button className="inline-flex items-center space-x-3 px-8 py-4 bg-gradient-to-r
